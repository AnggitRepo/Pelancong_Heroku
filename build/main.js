...
var MapsPage = /** @class */ (function () {
    ...
    MapsPage.prototype.loadMap = function () {
        ...
        this.http.get('https://sleepy-beyond-16232.herokuapp.com/api/gallery', { headers: headers })
...
var MapPage = /** @class */ (function () {
    ...
    MapPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-map',template:/*ion-inline-start:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\pages\map\map.html"*/'<!--\n  Generated template for the MapPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>MAP</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="onButtonClick()"> \n        <ion-icon name=\'locate\' style="font-size: 2rem; color: blue; ">MyLocation</ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n	<div  id="map_canvas"  style=" height: 100%"></div>\n</ion-content>\n '/*ion-inline-end:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\pages\map\map.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_geolocation__["a" /* Geolocation */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
    ], MapPage);
...
var TampildataPage = /** @class */ (function () {
    function TampildataPage(navCtrl, _TOAST, _HTTP) {
        ...
        this._TOAST = _TOAST;
        this._HTTP = _HTTP;
        this._HOST = "https://sleepy-beyond-16232.herokuapp.com/";
    }
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content class=" social-cards tutorial-page">\n  <ion-item *ngFor="let item of items">\n    <ion-card> \n      <div style="position: relative">\n        <ion-slides pager>\n        <ion-slide>\n          <img src="{{item.gambar}}" class="slide-image">\n        </ion-slide>\n        <ion-slide>\n          <img src="{{item.gambar2}}" class="slide-image">\n        </ion-slide>\n      </ion-slides>\n      </div>\n      <ion-card-content text-wrap>\n        <ion-card-title style="font-weight: bold; text-align: center;">\n          {{item.nama}}\n        </ion-card-title>\n        <p>{{item.keterangan}}</p>\n      </ion-card-content>\n      <ion-row>\n        <ion-col>\n          <button ion-button color="primary" clear small icon-start>\n            <ion-icon name=\'thumbs-up\'></ion-icon>\n            {{item.like}}\n          </button>\n        </ion-col>\n        <ion-col>\n          <button ion-button color="primary" clear small icon-start>\n            <ion-icon name=\'thumbs-down\'></ion-icon>\n            {{item.dislike}}\n          </button>\n        </ion-col>\n        <ion-col align-self-center text-center>\n          <ion-note>\n            {{item.date | date: "shortTime"}}\n          </ion-note>\n        </ion-col>\n      </ion-row>\n    </ion-card>\n  </ion-item>\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */]])
    ], HomePage);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\app\app.html"*/'<ion-menu id="myMenu" [content]="content">\n  <ion-header >\n    <ion-toolbar  color="danger">\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n      <ion-list >\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        <ion-icon name="{{p.icon}}" item-left></ion-icon>\n        {{p.title}}\n      </button>\n    </ion-list>\n    \n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\app\app.html"*/
        }),
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\pages\list\list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\pages\list\list.html"*/
        }),
...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\pages\login\login.html"*/'<ion-header>\n	<ion-navbar>\n		<button ion-button menuToggle>\n			<ion-icon name="menu"></ion-icon>\n		</button>\n		<ion-title>LOGIN</ion-title>\n	</ion-navbar>\n</ion-header>  \n\n<ion-content padding>\n	<ion-list>\n		<ion-item>\n			<ion-label floating>Username</ion-label>\n			<ion-input [(ngModel)] = "usercreds.username" type="text"></ion-input>\n		</ion-item>\n		<ion-item>\n			<ion-label floating>Password</ion-label>\n			<ion-input [(ngModel)] = "usercreds.password" type="password"></ion-input>\n		</ion-item>\n	</ion-list>\n	<ion-grid>\n		<ion-row>\n			<ion-col>\n				<div><button ion-button icon-left full (click)="menu()"><ion-icon name="unlock"></ion-icon>Login</button></div>\n			</ion-col>\n			<ion-col>\n				<div><button ion-button icon-left full (click)="signup()"><ion-icon name="person-add"></ion-icon>Register</button></div>\n			</ion-col>\n		</ion-row>\n	</ion-grid>\n</ion-content>\n'/*ion-inline-end:"C:\Users\asus\PENDADARAN\APP\PelancongHeroku\src\pages\login\login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
...
var AuthserviceProvider = /** @class */ (function () {
    ...
    AuthserviceProvider.prototype.authenticate = function (user) {
        ...
        return new Promise(function (resolve) {
            _this.http.post('https://sleepy-beyond-16232.herokuapp.com/api/authenticate', creds, { headers: headers }).subscribe(function (data) {
    ...
    AuthserviceProvider.prototype.adduser = function (user) {
        ...
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        return new Promise(function (resolve) {
            _this.http.post('https://sleepy-beyond-16232.herokuapp.com/api/signup', creds, { headers: headers }).subscribe(function (data) {
                if (data.json().success) {
                    resolve(true);
                }
                else
    ...
    AuthserviceProvider.prototype.getinfo = function () {
        ...
        return new Promise(function (resolve) {
            ...
            _this.http.get('https://sleepy-beyond-16232.herokuapp.com/api/memberinfo', { headers: headers }).subscribe(function (data) {
                if (data.json().success)
                    resolve(data.json());
                else
                    resolve(false);
...
var InputdataPage = /** @class */ (function () {
    function InputdataPage(navCtrl, navParams, _FB, _HTTP, geolocation, _TOAST, _IMAGE) {
        ...
        this._TOAST = _TOAST;
        this._IMAGE = _IMAGE;
        this._HOST = "https://sleepy-beyond-16232.herokuapp.com/api/gallery";
